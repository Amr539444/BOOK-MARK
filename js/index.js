...
var boxModal = document.querySelector(".boox-bok");
var bookmarks = [];
...
function displayBookmark(indexOfWebsite) {
  ...
  var newBookmark = `
                <tr>
                  ...
                  <td>
                    <button class="btn btn-delet pe-2" data-index="${indexOfWebsite}">
  ...
  deleteBtns = document.querySelectorAll(".btn-delet");
  if (deleteBtns) {
...
document.addEventListener("click", function (e) {
  if (e.target.classList.contains("boox-bok")) {
    closeModal();
  }
});
